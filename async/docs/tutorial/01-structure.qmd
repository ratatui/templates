...
![Top half is a Iterm2 terminal with the TUI showing a Horizontal split with tui-logger widget. Bottom half is a ITerm2 terminal showing the output of running `tail -f` on the log file.](https://user-images.githubusercontent.com/1813121/254093932-46d8c6fd-c572-4675-bcaf-45a36eed51ff.png)
...
We'll learn more about the `TerminalHandler` in the next section.
