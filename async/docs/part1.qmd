...
For example, if we wanted to have a vertical and horizontal scroll bar, and wanted to change the state of the scrollbar we might have to write code like this:
...
But in addition to changing the state of the scroll bar, we may also want to do additional things (e.g. scroll down a table) and this code could get more complicated.
