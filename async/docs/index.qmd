...
This [project](https://github.com/kdheepak/ratatui-template) is an opinionated template for getting up and running with `ratatui`.
This documentation is a walk-through of why the code is structured the way it is, so you can modify it as you need.
