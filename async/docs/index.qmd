...
The [source code of this project](https://github.com/kdheepak/ratatui-template) is an opinionated template for getting up and running with `ratatui`.
You can pick and choose the pieces of this `ratatui-template` to suit your needs and sensibilities.
